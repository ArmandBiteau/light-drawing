...
void main() {
    ...
    float r = mix(iColor1.r + snoise2(vPosition.yz)/8.0, iColor2.r + snoise2(vPosition.xy)/8.0, 1.0);
    float g = mix(iColor1.g + snoise2(vPosition.xz)/5.0, iColor2.g + snoise2(vPosition.xz)/5.0, 1.0);
    float b = mix(iColor1.b + snoise2(vPosition.xy)/10.0, iColor2.b + snoise2(vPosition.yz)/8.0, 1.0);
    float a = 1.0;
